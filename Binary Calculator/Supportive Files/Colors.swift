...
struct Colors {
    ...
    static let darkSilver = UIColor(red: 207.0/255.0, green: 217.0/255.0, blue: 223.0/255.0, alpha: 1.0)
    static let lightSilver = UIColor(red: 226.0/255.0, green: 235.0/255.0, blue: 240.0/255.0, alpha: 1.0)
    static let someGreen = UIColor(red: 40.0/255.0, green: 207.0/255.0, blue: 208.0/255.0, alpha: 1.0)
    static let veryDarkBlue = UIColor(red: 51.0/255.0, green: 8.0/255.0, blue: 103.0/255.0, alpha: 1.0)
}
